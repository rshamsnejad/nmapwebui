...
# UID and GID have been chosen to be in the "Host users mapped into containers" range.
...
# Copy some more up-to-date Nmap auxiliary files
COPY ./nmap-data/nmap-mac-prefixes /usr/share/nmap/nmap-mac-prefixes
COPY ./nmap-data/dnssd.lua /usr/share/nmap/nselib/dnssd.lua
